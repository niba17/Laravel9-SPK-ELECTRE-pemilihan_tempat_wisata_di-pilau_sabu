...
@section('title', 'ELECTRE | Kecamatan, Kelurahan & Desa')
@section('content')
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <hr>
                                    <a href="/desa-add" class="btn btn-sm btn-primary mb-3">Tambah Desa
                                        <i class="fa-solid fa-plus ml-1"></i>
                                    </a>
                                    {{-- <p class="card-description">
                                Add class <code>.table-hover</code>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-bordered table-striped" id="myTable5">
                                            <thead class="table-primary">
                                                <tr>
                                                    <th>No</th>
                                                    <th>Desa</th>
                                            ...
                                            <tbody>
                                                @foreach ($desa as $item_desa)
                                                    <tr>
                                                        <th>{{ $loop->iteration }}</th>
                                                        <td>{{ $item_desa->nama }}</td>
                                                        <td class="d-flex justify-content-center">
                                                            <a href="desa-edit/{{ $item_desa->id }}">
                                                                <i class="fa-solid fa-pen-to-square text-primary"></i>
                                                            </a>
                                                            <span class="px-1">|</span>
                                                            <a href="#"
                                                                onclick="hapus('{{ $item_desa->id }}','desa')">
                                                                <i class="fa-regular fa-trash-can text-danger"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <h4 class="card-title">Relasi Kelurahan & Desa</h4>
                                    <hr>
                                    <a href="/kelurahan_desa-add" class="btn btn-sm btn-primary mb-3">Tambah Relasi
                                        <i class="fa-solid fa-plus ml-1"></i>
                                    </a>
                                    {{-- <p class="card-description">
                                Add class <code>.table-hover</code>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-bordered table-striped" id="myTable4">
                                            <thead class="table-primary">
                                                <tr>
                                                    <th>No</th>
                                                    <th>Kelurahan</th>
                                            ...
                                            <tbody>
                                                @foreach ($kelurahan as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->nama }}</td>
                                                        <td>
                                                            @if (isset($item->kelurahan_desa) && count($item->kelurahan_desa) > 0)
                                                                @foreach ($item->kelurahan_desa as $item2)
                                                                    <li class="py-1">
                                                                        {{ $item2->desa->nama }}
                                                                    </li>
                                                                @endforeach
                                                            @else
                                                                <span class="text-danger">
                                                                    <span class="badge bg-danger-faded text-danger">Desa
                                                                        belum dipilih!
                                                                    </span>
                                                                </span>
                                                            @endif
                                                        ...
                                                        <td class="d-block">
                                                            @foreach ($item->kelurahan_desa as $item4)
                                                                <div class="d-flex justify-content-center py-1">
                                                                    <a href="kelurahan_desa-edit/{{ $item4->id }}">
                                                                        <i
                                                                            class="fa-solid fa-pen-to-square text-primary"></i>
                                                                    </a>
                                                                    <span class="px-1 fw-bold">|</span>
                                                                    <a href="#"
                                                                        onclick="hapus('{{ $item4->id }}','kelurahan_desa')">
                                                                        <i class="fa-regular fa-trash-can text-danger"></i>
                                                                    </a>
                                                                </div>
                                                            @endforeach
