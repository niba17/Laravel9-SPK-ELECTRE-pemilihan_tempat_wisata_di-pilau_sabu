...
class SubKriteriaController extends Controller
{
    ...
    {
        $lokasi_wisata = LokasiWisata::with(['siswa_sub_kriteria.kriteria'])->get();
        $kriteria = Kriteria::with(['siswa_sub_kriteria.lokasi_wisata'])->get();

        return response()->json([$kriteria, $lokasi_wisata]);
    }
}